        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li class="treeview">
            ...
            <ul class="treeview-menu">
              <li><a href="<?=site_url('mahasiswa/formcuti_mahasiswa')?>"><i class="fa fa-circle-o"></i>Form Pengajuan Cuti</a></li>
              <li><a href="<?=site_url('mahasiswa/data_pengajuancuti')?>"><i class="fa fa-circle-o"></i> Status Pengajuan Cuti</a></li>
