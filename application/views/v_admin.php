...
<head>
  ...
  <link href="https://cdn.datatables.net/v/bs/jq-3.6.0/jszip-2.5.0/dt-1.13.4/af-2.5.3/b-2.3.6/b-colvis-2.3.6/b-html5-2.3.6/b-print-2.3.6/r-2.4.1/datatables.min.css" rel="stylesheet"/>
 
<script src="https://cdnjs.cloudflare.com/ajax/libs/pdfmake/0.2.7/pdfmake.min.js"></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/pdfmake/0.2.7/vfs_fonts.js"></script>
<script src="https://cdn.datatables.net/v/bs/jq-3.6.0/jszip-2.5.0/dt-1.13.4/af-2.5.3/b-2.3.6/b-colvis-2.3.6/b-html5-2.3.6/b-print-2.3.6/r-2.4.1/datatables.min.js"></script>
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li class="treeview">
            ...
            <ul class="treeview-menu">
              <li><a href="<?=site_url('admin/data_admin')?>"><i class="fa fa-circle-o"></i> Data Admin</a></li>
              <li><a href="<?=site_url('admin/data_kaprodi')?>"><i class="fa fa-circle-o"></i> Data Kaprodi</a></li>
              <li><a href="<?=site_url('admin/data_mahasiswa')?>"><i class="fa fa-circle-o"></i> Data Mahasiswa</a></li>
              <li><a href="<?=site_url('admin/data_pengajuancuti')?>"><i class="fa fa-circle-o"></i> Data Pengajuan Cuti </a></li>
            </ul>
          </li>
